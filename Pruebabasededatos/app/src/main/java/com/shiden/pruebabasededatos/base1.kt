...
import kotlinx.android.synthetic.main.activity_base1.*
import kotlinx.android.synthetic.main.activity_main.*
import kotlinx.android.synthetic.main.ticket.view.*

class base1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener{
           ...
           // view -> Toast.makeText(this,"Se a eliminado toda la informacion de la base de datos", Toast.LENGTH_SHORT).show()
