...
class Seleccionar_Imagen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_seleccionar__imagen)
        ...
        imageview = findViewById<View>(R.id.ivImagen2) as ImageView
        ...
        btn!!.setOnClickListener {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
                ...
                if (checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE)==
                    ...
                    requestPermissions(permissions, Seleccionar_Imagen.PERMISSION__CODE)
        ...
        if (requestCode == GALLERY)
        {
            if (data != null)
            {
                ...
                try
                {
                    ...
                    e.printStackTrace()
                    Toast.makeText(this@Seleccionar_Imagen, "Failed!", Toast.LENGTH_SHORT).show()
                }
    ...
    fun saveImage(myBitmap: Bitmap):String {
        ...
        val wallpaperDirectory = File(
            (Environment.getExternalStorageDirectory()).toString() + Seleccionar_Imagen.IMAGE_DIRECTORY
        )
    ...
    override fun onRequestPermissionsResult(
        ...
        when (requestCode){
            ...
            Seleccionar_Imagen.PERMISSION__CODE -> {
